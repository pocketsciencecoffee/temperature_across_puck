...
ax1.plot(probe_time['above_puck_screen'], normalized_probe_temp['above_puck_screen'], label='probe_above_puck_screen', color='#fde725')
...
ax1.plot(probe_time['below_puck_screen'], normalized_probe_temp['below_puck_screen'], label='probe_below_puck_screen', color='#7ad151')
...
ax1.plot(probe_time['75_above_bottom'], normalized_probe_temp['75_above_bottom'], label='probe_75_above_bottom', color='#22a884')
...
ax1.plot(probe_time['50_above_bottom'], normalized_probe_temp['50_above_bottom'], label='probe_50_above_bottom', color='#2a788e')
...
ax1.plot(probe_time['25_above_bottom'], normalized_probe_temp['25_above_bottom'], label='probe_25_above_bottom', color='#414487')
...
ax1.plot(probe_time['bottom'], normalized_probe_temp['bottom'], label='probe_at_bottom', color='#440154')
...
# Rohan - Cycle through colors by assigning them. Somehow cycler didn't work in a for loop
for (tracepoint, clr) in zip(temp_trace.keys(), itertools.cycle(colors)):
    ax3.plot(time_trace[tracepoint], temp_trace[tracepoint], label = tracepoint, color=clr)
